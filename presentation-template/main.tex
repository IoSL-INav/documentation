...
\begin{frame}{Use case}
	...
	\todo{Add Mensa plan with colored dots (=> people) distributed over the floor}
...
\begin{frame}{Approaches to indoor positioning}
    ...
    \only<3>{\includegraphics[width=\textwidth]{matrix_zweiteVersion_wifi_beacon_highlighted}}
