...
\title[\Huge Internet of Services Lab]{Indoor Navigation}
...
\begin{frame}{The mensa problem}
    ...
    \todo{link for mensa source}
    \tiny{source: \url{http://www.berlin-studis.de/images/stories/TU-Universitaetsbibliothek.jpg}}
...
\begin{frame}{Localication ideas}
    \begin{itemize}
...
\begin{frame}{WiFi positioning via \textbf{CISCO MSI API}}
    ...
    \todo{show snipp of measurements and show reference to cisco MSI API}
...
\begin{frame}{Timeline}
    ...
    \todo{dont to gantt, make a table and name the first and the last once}
    \todo{example: pinning (basic), pinning (advanced), postitioning (basic)...}
