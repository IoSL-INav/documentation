...
\begin{frame}{Bluetooth}
	...
	\begin{center}
		...
		\includegraphics[width=0.8\textwidth]{box_devkit}
...
\begin{frame}{Bluetooth}
	...
	\todo{what to do with this slide? }
	\todo{live positioning and d2d have to be moved to posible future work or smth}
	\begin{itemize} 
...
\begin{frame}{WiFi positioning}
	...
	\begin{itemize}
		...
		\item Intended for rough positioning where no beacons are available
		\item Problems: 
			\begin{itemize}
...
\begin{frame}{Manual position pinning}
	...
	\begin{itemize}
		...
		\item \todo{this has to be moved to approaches}
