...
\begin{frame}{Functionalities}
  ...
  \begin{itemize}
    \item User opens app and gets a login to his university
    \item Add friends
...
\begin{frame}{Technologic decisions}
  ...
  \begin{center}
    ...
    \includegraphics[width=0.8\textwidth,draft]{tech-stack-big-picture}
  \end{center}
