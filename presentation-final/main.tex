...
\begin{frame}[t]{Localization techniques}
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.3\textwidth}
      \includegraphics[width=0.8\textwidth]{beaconsonthemapwithoutborder}%iOS or android screenshot without borders
    \end{column}
  \end{columns}
...
\begin{frame}{Mobile clients - Platform specifics}
  ...
  \begin{itemize}
    ...
    \item MSE and Beacon scanning with services
    \item Automatic service updating user's location with most precise location info available \\(pinpointed coordinates > beacon ID > MSE info)
