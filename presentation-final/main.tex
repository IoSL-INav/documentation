...
\begin{frame}{Mobile clients - Location sharing}
  ...
  \textbf{Three localization techniques}\\[1em]
  \begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \raisebox{-8pt}[0pt][0pt]{\includegraphics[width=0.1\textwidth]{wifi-symbol}}~~~~>~~~~%
          \raisebox{-8pt}[0pt][0pt]{\includegraphics[width=0.1\textwidth]{beacon-symbol}}~~~~>~~~~%
          \raisebox{-8pt}[0pt][0pt]{\includegraphics[width=0.1\textwidth]{location-symbol}}
