...
\begin{frame}{Localization techniques}
  ...
  \begin{columns}
    ...
    \begin{column}{0.3\textwidth}
      \includegraphics[width=\textwidth]{beaconfunctionality}%iOS or android screenshot without borders
    \end{column}
...
\begin{frame}{Localization techniques}
  ...
  \begin{columns}
    ...
    \hfill
    \begin{column}{0.3\textwidth}
      \includegraphics[width=0.8\textwidth]{manualpinpoint}%iOS or android screenshot without borders
    \end{column}
...
\begin{frame}{Mobile clients - Share Position}
  ...
  Share your Position
  \todo{Need Share your position screenshot Android}
  \begin{columns}[T]
	%\begin{column}{.6\textwidth}
	%\begin{itemize}
